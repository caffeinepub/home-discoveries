...
export class Backend implements backendInterface {
    ...
    async addBoard(arg0: string, arg1: Board): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBoard(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addPost(arg0: string, arg1: Post): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllBoards(): Promise<Array<Board>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBoards();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBoardById(arg0: string): Promise<Board> {
        if (this.processError) {
            try {
                const result = await this.actor.getBoardById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeBoard(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeBoard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBoard(arg0: string, arg1: Board): Promise<void> {
        if (this.processError) {
            try {
